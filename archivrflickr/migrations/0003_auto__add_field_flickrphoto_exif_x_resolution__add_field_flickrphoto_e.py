...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlickrPhoto.exif_x_resolution'
        db.add_column('archivrflickr_flickrphoto', 'exif_x_resolution',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_y_resolution'
        db.add_column('archivrflickr_flickrphoto', 'exif_y_resolution',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FlickrPhoto.exif_x_resolution'
        db.delete_column('archivrflickr_flickrphoto', 'exif_x_resolution')

        # Deleting field 'FlickrPhoto.exif_y_resolution'
        db.delete_column('archivrflickr_flickrphoto', 'exif_y_resolution')
