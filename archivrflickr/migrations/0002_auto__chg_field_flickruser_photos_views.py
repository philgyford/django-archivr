...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FlickrUser.photos_views'
        db.alter_column('archivrflickr_flickruser', 'photos_views', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    def backwards(self, orm):

        # Changing field 'FlickrUser.photos_views'
        db.alter_column('archivrflickr_flickruser', 'photos_views', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))
    models = {
        'archivr.archivritem': {
