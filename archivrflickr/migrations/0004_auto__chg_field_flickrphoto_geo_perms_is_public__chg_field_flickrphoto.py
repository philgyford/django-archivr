...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FlickrPhoto.geo_perms_is_public'
        db.alter_column('archivrflickr_flickrphoto', 'geo_perms_is_public', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'FlickrPhoto.geo_perms_is_family'
        db.alter_column('archivrflickr_flickrphoto', 'geo_perms_is_family', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'FlickrPhoto.geo_perms_is_contact'
        db.alter_column('archivrflickr_flickrphoto', 'geo_perms_is_contact', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'FlickrPhoto.geo_perms_is_friend'
        db.alter_column('archivrflickr_flickrphoto', 'geo_perms_is_friend', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    def backwards(self, orm):

        # Changing field 'FlickrPhoto.geo_perms_is_public'
        db.alter_column('archivrflickr_flickrphoto', 'geo_perms_is_public', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'FlickrPhoto.geo_perms_is_family'
        db.alter_column('archivrflickr_flickrphoto', 'geo_perms_is_family', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'FlickrPhoto.geo_perms_is_contact'
        db.alter_column('archivrflickr_flickrphoto', 'geo_perms_is_contact', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'FlickrPhoto.geo_perms_is_friend'
        db.alter_column('archivrflickr_flickrphoto', 'geo_perms_is_friend', self.gf('django.db.models.fields.BooleanField')())
    models = {
        'archivr.archivritem': {
        ...
        'archivrflickr.flickrphoto': {
            ...
            'geo_perms_is_contact': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'geo_perms_is_family': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'geo_perms_is_friend': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'geo_perms_is_public': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
