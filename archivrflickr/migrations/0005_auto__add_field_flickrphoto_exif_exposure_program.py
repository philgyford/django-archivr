...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlickrPhoto.exif_exposure_program'
        db.add_column('archivrflickr_flickrphoto', 'exif_exposure_program',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FlickrPhoto.exif_exposure_program'
        db.delete_column('archivrflickr_flickrphoto', 'exif_exposure_program')
