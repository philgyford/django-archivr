...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FlickrPhoto.exif_iso'
        db.delete_column('archivrflickr_flickrphoto', 'exif_iso')

        # Adding field 'FlickrPhoto.large1600_width'
        db.add_column('archivrflickr_flickrphoto', 'large1600_width',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.large1600_height'
        db.add_column('archivrflickr_flickrphoto', 'large1600_height',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.large2048_width'
        db.add_column('archivrflickr_flickrphoto', 'large2048_width',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.large2048_height'
        db.add_column('archivrflickr_flickrphoto', 'large2048_height',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_gps_version_id'
        db.add_column('archivrflickr_flickrphoto', 'exif_gps_version_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_gps_latitude'
        db.add_column('archivrflickr_flickrphoto', 'exif_gps_latitude',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_gps_longitude'
        db.add_column('archivrflickr_flickrphoto', 'exif_gps_longitude',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_host_computer'
        db.add_column('archivrflickr_flickrphoto', 'exif_host_computer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_iso_speed'
        db.add_column('archivrflickr_flickrphoto', 'exif_iso_speed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'FlickrPhoto.exif_iso'
        db.add_column('archivrflickr_flickrphoto', 'exif_iso',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'FlickrPhoto.large1600_width'
        db.delete_column('archivrflickr_flickrphoto', 'large1600_width')

        # Deleting field 'FlickrPhoto.large1600_height'
        db.delete_column('archivrflickr_flickrphoto', 'large1600_height')

        # Deleting field 'FlickrPhoto.large2048_width'
        db.delete_column('archivrflickr_flickrphoto', 'large2048_width')

        # Deleting field 'FlickrPhoto.large2048_height'
        db.delete_column('archivrflickr_flickrphoto', 'large2048_height')

        # Deleting field 'FlickrPhoto.exif_gps_version_id'
        db.delete_column('archivrflickr_flickrphoto', 'exif_gps_version_id')

        # Deleting field 'FlickrPhoto.exif_gps_latitude'
        db.delete_column('archivrflickr_flickrphoto', 'exif_gps_latitude')

        # Deleting field 'FlickrPhoto.exif_gps_longitude'
        db.delete_column('archivrflickr_flickrphoto', 'exif_gps_longitude')

        # Deleting field 'FlickrPhoto.exif_host_computer'
        db.delete_column('archivrflickr_flickrphoto', 'exif_host_computer')

        # Deleting field 'FlickrPhoto.exif_iso_speed'
        db.delete_column('archivrflickr_flickrphoto', 'exif_iso_speed')
