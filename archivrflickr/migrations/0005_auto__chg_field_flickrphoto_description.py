...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FlickrPhoto.description'
        db.alter_column('archivrflickr_flickrphoto', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    def backwards(self, orm):

        # Changing field 'FlickrPhoto.description'
        db.alter_column('archivrflickr_flickrphoto', 'description', self.gf('django.db.models.fields.TextField')(default=''))
    models = {
        'archivr.archivritem': {
