...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlickrPhoto.exif_camera'
        db.add_column('archivrflickr_flickrphoto', 'exif_camera',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_date_and_time_digitized'
        db.add_column('archivrflickr_flickrphoto', 'exif_date_and_time_digitized',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_date_and_time_modified'
        db.add_column('archivrflickr_flickrphoto', 'exif_date_and_time_modified',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_date_and_time_original'
        db.add_column('archivrflickr_flickrphoto', 'exif_date_and_time_original',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_exposure_bias'
        db.add_column('archivrflickr_flickrphoto', 'exif_exposure_bias',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_max_aperture_value'
        db.add_column('archivrflickr_flickrphoto', 'exif_max_aperture_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FlickrPhoto.exif_ycbcr_positioning'
        db.add_column('archivrflickr_flickrphoto', 'exif_ycbcr_positioning',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FlickrPhoto.exif_camera'
        db.delete_column('archivrflickr_flickrphoto', 'exif_camera')

        # Deleting field 'FlickrPhoto.exif_date_and_time_digitized'
        db.delete_column('archivrflickr_flickrphoto', 'exif_date_and_time_digitized')

        # Deleting field 'FlickrPhoto.exif_date_and_time_modified'
        db.delete_column('archivrflickr_flickrphoto', 'exif_date_and_time_modified')

        # Deleting field 'FlickrPhoto.exif_date_and_time_original'
        db.delete_column('archivrflickr_flickrphoto', 'exif_date_and_time_original')

        # Deleting field 'FlickrPhoto.exif_exposure_bias'
        db.delete_column('archivrflickr_flickrphoto', 'exif_exposure_bias')

        # Deleting field 'FlickrPhoto.exif_max_aperture_value'
        db.delete_column('archivrflickr_flickrphoto', 'exif_max_aperture_value')

        # Deleting field 'FlickrPhoto.exif_ycbcr_positioning'
        db.delete_column('archivrflickr_flickrphoto', 'exif_ycbcr_positioning')
